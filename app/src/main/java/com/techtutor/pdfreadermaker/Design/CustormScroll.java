package com.techtutor.pdfreadermaker.Design;
...
public class CustormScroll extends RelativeLayout implements ScrollHandle {
    ...
    public CustormScroll(Context context) {
        this(context, false);
    }

    public CustormScroll(Context context, boolean inverted) {
        super(context);
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, R.drawable.scroll_handle_left);
            } else { // right
                align = ALIGN_PARENT_RIGHT;
                background = ContextCompat.getDrawable(context, R.drawable.scroll_handle_right);
            }
        } else {
            width = HANDLE_SHORT;
            height = HANDLE_LONG;
